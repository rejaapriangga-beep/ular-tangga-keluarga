...
- **Papan hangat & hidup**: papan 7x14 (7 kotak per baris, 98 kotak total) dengan checkerboard warna hijau lembut, lebar papan selalu memenuhi penuh lebar layar (kotak jadi jauh lebih besar karena lebar dibagi 7, bukan 10) dan bisa digulir (scroll) vertikal karena papan lebih tinggi dari satu layar — otomatis mulai dari kotak 1 di bagian bawah. Tangga & ular didesain dengan jarak antar kotak yang lebih pendek (maksimal ~3 baris) supaya papan tidak terlihat berantakan meski kotaknya besar. Tangga digambar dengan dua rel + anak tangga (bukan garis polos), ular digambar seram dengan badan menyambung meruncing ke ekor, kepala berbentuk oval menghadap keluar lengkap dengan mata sipit kuning dan lidah bercabang merah (bukan lagi seperti cacing), plus backdrop vektor bertema (bukit & pohon di Hutan Tropis, gedung neon di Kota Malam, bintang & planet di Luar Angkasa) di belakang papan. Pion pemain berupa token karakter hewan (🦁🐼🐰🦖) berukuran besar di atas lingkaran berwarna, berpindah dengan animasi halus per kotak (bukan lompat kaku). Dadu putih dengan titik (pip) seperti dadu asli, selalu di posisi tengah layar, dan berubah abu-abu otomatis saat bukan giliran pemain tersebut. Info giliran ditampilkan sebagai pita warna besar berisi avatar & nama pemain aktif ("Giliran ..."), plus pesan status permainan yang tampil dalam kartu warna agar lebih mudah terbaca. Judul ditampilkan sebagai "papan nama kayu" ala petualangan.
