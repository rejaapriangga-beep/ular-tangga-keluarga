...
- **Papan hangat & hidup**: papan 7x14 (7 kotak per baris, 98 kotak total) dengan checkerboard warna hijau lembut, kotak besar mengikuti tinggi ruang yang tersedia (tanpa scroll, papan selalu utuh dalam satu layar). Tangga & ular didesain dengan jarak antar kotak yang lebih pendek (maksimal ~3 baris) supaya papan tidak terlihat berantakan. Tangga digambar dengan dua rel + anak tangga (bukan garis polos), ular digambar seram dengan badan menyambung meruncing ke ekor, kepala berbentuk oval menghadap keluar lengkap dengan mata sipit kuning dan lidah bercabang merah, plus backdrop vektor bertema (bukit & pohon di Hutan Tropis, gedung neon di Kota Malam, bintang & planet di Luar Angkasa) di belakang papan. Pion pemain berupa lingkaran warna dengan inisial karakter (bukan emoji kecil) supaya tetap terbaca di papan yang padat. Dadu putih dengan titik (pip) seperti dadu asli, selalu di posisi tengah layar, dan berubah abu-abu otomatis saat bukan giliran pemain tersebut. Info giliran tampil sebagai popup singkat (bukan bar permanen) setiap kali giliran berganti, plus pesan status permainan yang tampil dalam kartu warna agar lebih mudah terbaca. Judul ditampilkan sebagai "papan nama kayu" ala petualangan.
